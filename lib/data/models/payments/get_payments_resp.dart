class GetPaymentsResp {
  String? entity;
  int? count;
  List<Items>? items;

  GetPaymentsResp({this.entity, this.count, this.items});

  GetPaymentsResp.fromJson(Map<String, dynamic> json) {
    entity = json['entity'];
    count = json['count'];
    if (json['items'] != null) {
      items = <Items>[];
...
class Notes {
  ...
  Notes({this.policyName, this.dashboard});
